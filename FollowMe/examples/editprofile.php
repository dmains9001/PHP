						...
						<div class="row">
								<div class="col-md-8 ml-auto mr-auto">
										...
										<form class="contact-form" action="" method="post">
												...
												<textarea class="form-control" rows="4" value="<?php echo $_SESSION['description'];?>" name="description" placeholder="Describe yourself for everyone!"></textarea>"<?php echo $_SESSION['description'];?>"
												<div class="row">
